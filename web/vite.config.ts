...
// One HTML file out. The same artifact is served three ways — Cloudflare Pages,
// GitHub Pages, and a local file:// open — so nothing
...
export default defineConfig({
  ...
  // inside a sandboxed srcdoc iframe, which can show mojibake (× -> Ã—).
