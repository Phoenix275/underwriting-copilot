...
/* ---------- sign-in ambience: one composition, not scattered shapes ----------
   A fine dot-grid field, two slow breathing glows, and a centred halo of
   rings the shell sits inside — symmetric and deliberate. Pure CSS,
...
.lg-dots{position:absolute;inset:0;background-image:radial-gradient(rgba(106,103,247,.20) 1px,transparent 1.5px);background-size:28px 28px;
 -webkit-mask-image:radial-gradient(ellipse 130% 120% at 50% 50%,rgba(0,0,0,.9),transparent 78%);mask-image:radial-gradient(ellipse 130% 120% at 50% 50%,rgba(0,0,0,.9),transparent 78%)}
.lg-glow{position:absolute;width:680px;height:680px;border-radius:50%;filter:blur(95px);opacity:.5;animation:lgBreathe 16s ease-in-out infinite alternate}
.lg-glow.ga{background:#8B88FF;top:-240px;left:-200px}
.lg-glow.gb{background:#5A57E0;bottom:-280px;right:-220px;animation-delay:-8s}
@keyframes lgBreathe{from{transform:translate(0,0) scale(1)}to{transform:translate(56px,36px) scale(1.07)}}
.lg-halo{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);border:1px solid rgba(106,103,247,.30);border-radius:50%;width:980px;height:980px}
.lg-halo.h2{width:1280px;height:1280px;border-color:rgba(106,103,247,.17)}
.lg-halo.h3{width:1580px;height:1580px;border-color:rgba(106,103,247,.09)}
:root[data-theme="light"] .lg-glow{opacity:.34}
@media (prefers-reduced-motion:reduce){.lg-glow{animation:none}}
...
<div id="login">
 <div class="lg-geo" aria-hidden="true">
  ...
  <div class="lg-glow ga"></div>
  <div class="lg-glow gb"></div>
  <div class="lg-halo"></div>
  <div class="lg-halo h2"></div>
  <div class="lg-halo h3"></div>
 </div>
