...
/* =================== LIGHT MODE (toggle) =================== */
/* both floating controls share one fixed top-right rack — the Interactive
   Guide button sits at the screen's right edge, theme toggle to its left */
...
#tourBtn{height:40px;padding:0 16px;border-radius:999px;border:none;background:var(--acc);color:#fff;font:600 12.5px 'Poppins',sans-serif;cursor:pointer;box-shadow:0 6px 18px rgba(87,84,240,.4);display:flex;align-items:center;gap:6px}
...
<button id="uwgBtn" onclick="uwgToggle()" title="Guide — underwriting knowledge assistant">💬 Guide</button>
<div id="uwgPanel" role="dialog" aria-label="Guide knowledge assistant">
 <div class="uwg-head"><div><b>Guide</b><div class="uwg-sub" id="uwgSub">Knowledge assistant · guidelines · product rules · process</div></div><span class="uwg-x" onclick="uwgToggle()" title="Close">✕</span></div>
...
const TUTORIAL_STEPS=[
 ...
 {title:`Ask it anything — the Guide`,
  do:`The Guide, open at the bottom right. It's on every screen after sign-in.`,
...
function uwgToggle(){
 ...
 if(on&&!uwgBooted){uwgBooted=true;
  uwgMsg('Hi — I’m the <b>Guide</b>. Ask me about underwriting guidelines, product rules, risk-scoring, or process. I can also look up any applicant by name or case ID (“what is '+CASES[0].name+'’s weight?”) and rank the auto-approved or auto-declined book.','bot');}
