...
/* ---------- sign-in ambience: gradient beams + frosted glass panes ----------
   Stripe-style diagonal colour beams sweeping behind the shell, with frosted
   glass slabs floating over them at the same angle — the blur through the
   glass is real (backdrop-filter), which is what sells the depth. A different
   vocabulary from the landing page: no rings, no orbits, no dots. */
.login-shell{position:relative;z-index:2}
.lg-geo{position:absolute;inset:0;z-index:0;pointer-events:none;overflow:hidden}
.lg-beams{position:absolute;inset:-12%;transform:rotate(-16deg)}
.lg-beams i{position:absolute;left:-8%;right:-8%;border-radius:999px;filter:blur(26px);animation:beamDrift 22s ease-in-out infinite alternate}
.lg-beams .b1{top:12%;height:120px;background:linear-gradient(90deg,transparent,#8B88FF 30%,#6A67F7 60%,transparent);opacity:.55}
.lg-beams .b2{top:30%;height:74px;background:linear-gradient(90deg,transparent,#C4B5FD 40%,#A78BFA 70%,transparent);opacity:.45;animation-delay:-7s}
.lg-beams .b3{top:62%;height:150px;background:linear-gradient(90deg,transparent 10%,#5B58E8 45%,#8B88FF 75%,transparent);opacity:.5;animation-delay:-13s}
.lg-beams .b4{top:82%;height:64px;background:linear-gradient(90deg,transparent,#B9A8F5 50%,transparent);opacity:.4;animation-delay:-18s}
@keyframes beamDrift{from{transform:translateX(-70px)}to{transform:translateX(70px)}}
.lg-pane{position:absolute;border-radius:22px;border:1px solid rgba(255,255,255,.5);
 background:linear-gradient(135deg,rgba(255,255,255,.20),rgba(255,255,255,.04) 55%,rgba(255,255,255,.10));
 backdrop-filter:blur(13px) saturate(1.25);-webkit-backdrop-filter:blur(13px) saturate(1.25);
 box-shadow:0 24px 60px rgba(40,38,120,.16),inset 0 1px 0 rgba(255,255,255,.55);
 transform:rotate(-16deg);animation:paneFloat 11s ease-in-out infinite alternate}
.lg-pane.p1{width:250px;height:330px;right:4.5%;top:7%}
.lg-pane.p2{width:200px;height:265px;left:3.5%;bottom:9%;animation-delay:-4s}
.lg-pane.p3{width:110px;height:140px;left:13%;top:13%;animation-delay:-8s;border-radius:16px}
@keyframes paneFloat{from{transform:rotate(-16deg) translateY(0)}to{transform:rotate(-16deg) translateY(-18px)}}
:root[data-theme="light"] .lg-beams i{opacity:.32}
:root[data-theme="light"] .lg-beams .b1{opacity:.4}
@media (prefers-reduced-motion:reduce){.lg-beams i,.lg-pane{animation:none}}
@media (max-width:880px){.lg-pane.p1{right:-8%}.lg-pane.p2{left:-8%}.lg-pane.p3{display:none}}
...
<div id="login">
 <div class="lg-geo" aria-hidden="true">
  <div class="lg-beams"><i class="b1"></i><i class="b2"></i><i class="b3"></i><i class="b4"></i></div>
  <div class="lg-pane p1"></div>
  <div class="lg-pane p2"></div>
  <div class="lg-pane p3"></div>
 </div>
